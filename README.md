...
| Version | Goal                                                                                                                  |
|---------|-----------------------------------------------------------------------------------------------------------------------|
| 0.1.0   | all basic sql commands have been implemented* and are working with the shell. The database responds to those commands |
...
| 0.8.0   | implementing order by / group by / having  - constraints                                                                                        |
